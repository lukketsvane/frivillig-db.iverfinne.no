...
export function generateStageGuidance(stage: EriksonStage): string {
  const guidance: Record<number, string> = {
    ...
    7: "For vaksne i generativitetsfasen søkjer eg etter organisasjonar der din erfaring, kompetanse og leiingsevner kan gje reell verdi til andre og samfunnet. Dette er tida for å mentor, rettleie og forme neste generasjon.",
